              ...
              child: Column(children: [
                Stack(
                  children: [
                    Image(
                      image:
                          AssetImage('images/sell_car/sell_car_banner@3x.png'),
                      fit: BoxFit.fill,
                    ),
                    Positioned(
                      bottom: 17,
                ...
                Container(
                  padding:
                      EdgeInsets.only(top: 0, left: 15, bottom: 15, right: 15),
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          Row(
                            crossAxisAlignment:
                                CrossAxisAlignment.start, // 垂直方向上顶部对齐
                            children: [
                              Image(
                                image: AssetImage('images/sell_car/circle.png'),
                                width: 15,
                                height: 15,
                              ),
                              SizedBox(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text:
                                            '，接受合作方来电服务接受合作方来电服务接受合作方来电服务接受合作方来电服务',
                                        style: TextStyle(
                                            fontSize: 14,
                                            color: Color(0xff000000)),
                                      ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                          ...
                          child: Row(
                            children: [
                              SizedBox(
                                ...
                                child: Container(
                                  decoration:
                                      BoxDecoration(color: Color(0xffFF9702)),
                                ),
                              ),
                              SizedBox(
                                width: 10,
                      ...
                      Container(
                        margin:
                            EdgeInsets.symmetric(vertical: 18, horizontal: 51),
                        child: Image(
                          image: AssetImage(
                              'images/sell_car/pic_sell_gaojiamaiche@2x.png'),
                          width: 273,
                          height: 73,
                        ),
                      )
                ...
                Image(
                    image:
                        AssetImage('images/sell_car/pic_sell_youshi@3x.png')),
              ]),
            )
          ],
        ));
